...
void setup() {
  ...
  //scale.set_scale(71.399);                      // this value is obtained by calibrating the scale with known weights; see the README for details
...
void loop() {
  ...
  if (500<scale.get_units() && scale.get_units()<600){
    Serial.print("Number");
    Serial.println(5);
  };
