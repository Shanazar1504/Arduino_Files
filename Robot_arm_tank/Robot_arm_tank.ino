...
void loop() {
  ...
  if (bt_data == 1) {
    turnLeft();  // if the bt_data is '1' the DC motor will go forward
  }
  else if (bt_data == 2) {
    turnRight(); // if the bt_data is '2' the motor will Reverse
  }
  else if (bt_data == 3) {
    forword(); // if the bt_data is '3' the motor will turn left
  }
  else if (bt_data == 4) {
    backword();// if the bt_data is '4' the motor will turn right
  }
  else if (bt_data == 5) {
