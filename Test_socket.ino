...
const char* deviceName = "Socket_control";
String serverUrl = "192.168.1.252";
String payload;
String device_key = "socket_control_esp";

ESP8266WebServer server(80);

void handleDevice() {
  String socket1 = server.arg("socket_pin_1");
  String socket2 = server.arg("socket_pin_2");
  String socket3 = server.arg("socket_pin_3");
