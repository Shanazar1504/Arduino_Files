...
void loop() {
  ...
  if (digitalRead(button1) == LOW) {
    // Handle action for button 1 (e.g., dispense water type 1)
     lcd.clear();
    lcd.setCursor(6, 0);
    lcd.print("Coke");
  ...
  if (digitalRead(button2) == LOW) {
    // Handle action for button 2 (e.g., dispense water type 2)
    lcd.clear();
     lcd.setCursor(6, 0);
    lcd.print("Fanta");
  ...
  if (digitalRead(button3) == LOW) {
    // Handle action for button 3 (e.g., dispense water type 3)
    lcd.clear();
     lcd.setCursor(5, 0);
    lcd.print("Sprite");
