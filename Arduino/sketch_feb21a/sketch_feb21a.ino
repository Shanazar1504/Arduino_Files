...
//  Alarm.alarmRepeat(20,51,0, MorningAlarm);  // 8:30am every day
//  Alarm.alarmRepeat(20,52,0,EveningAlarm);  // 5:45pm every day
  Alarm.alarmRepeat(dowThursday,21,03,30,WeeklyAlarm);  // 8:30:30 every Saturday
