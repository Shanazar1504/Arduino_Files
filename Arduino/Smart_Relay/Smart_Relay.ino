...
const char *ssid_name      = "****";         // название вашей WiFi сети
const char *ssid_password  = "********"; // пароль указанной выше WiFi сети

const char *broker_address = "tailor.cloudmqtt.com"; // адресс MQTT сервера 
const int  server_port     = 1883;                   // порт сервера
const char *user_name      = "*****";                // имя пользователя
const char *user_password  = "**********";           // пароль пользователя
