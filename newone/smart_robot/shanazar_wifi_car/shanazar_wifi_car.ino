...
#define ENB   2          // Enable/speed motors Left         GPIO12(D6)
#define IN_1  14          // L298N in1 motors Rightx          GPIO15(D8)
#define IN_2  12          // L298N in2 motors Right           GPIO13(D7)
#define IN_3  13           // L298N in3 motors Left            GPIO2(D4)
#define IN_4  15           // L298N in4 motors Left            GPIO0(D3)
